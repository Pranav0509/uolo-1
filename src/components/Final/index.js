      ...
      <div className="final-cont">
        <div className='main-cont-5'>
           <div className='big-img-cont'>
              <img className='big-img' src="https://www.uolo.com/images/award-hori.png"/>
           </div>
           <div className='Uolo-cont'>
               <h1>Uolo in media</h1>
           </div>
           <div className='imgs-cont'>
               <img className='comp-img' src="https://www.uolo.com/images/tech_crunch.svg"/>
               <img className='comp-img' src="https://www.uolo.com/images/Logo_Inc%2042.svg"/>
               <img className='comp-img' src="https://www.uolo.com/images/entrackr.svg"/>
               <img className='comp-img' src="https://www.uolo.com/images/Logo_ET.svg" />
               <img className='comp-img' src="https://www.uolo.com/images/Logo_Financial_express.svg"/>
           </div>
        </div>
